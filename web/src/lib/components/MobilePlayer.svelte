...
<div style="flex:none; position:relative; border-top:1px solid var(--border-strong); background:var(--bg-surface-raised); background-image:var(--scanline);">
  ...
  <div style="display:flex; align-items:center; gap:12px; padding:11px 14px;">
    <div style="position:relative; width:44px; height:44px; flex:none; border-radius:var(--radius-sm); overflow:hidden; background:{np ? np.gradient : 'var(--ink-700)'}; display:flex; align-items:flex-end; padding:5px; box-sizing:border-box;">
